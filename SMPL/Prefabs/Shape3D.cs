...
namespace SMPL.Prefabs
{
	public class Shape3D : Visual
	{
		...
		public void Display(Camera camera)
		{
			...
			{
				Debug.LogError(1,
					$"Cannot display the {nameof(Shape3D)} instance '{UID}' because it has no {nameof(Components.Area)}.\n" +
		...
		public void SetColorTintLight(double angle, double depth)
		{
			...
			{
				Debug.LogError(1,
					$"Cannot tint the {nameof(Shape3D)} instance '{UID}' because it has no {nameof(Components.Area)}.\n" +
